...
func (f *fakeBackend) ThemesForRender(minWeight float64, limit int) ([]store.ThemeView, error) {
	panic("unexpected ThemesForRender call")
}
func (f *fakeBackend) MaybeRecomputeThemes(vaultRoot, trigger string, p store.ClusterParams) (*store.ClusterRun, error) {
	panic("unexpected MaybeRecomputeThemes call")
}
func (f *fakeBackend) RecomputeThemes(vaultRoot, trigger string, p store.ClusterParams) (*store.ClusterRun, error) {
...
func (f *fakeBackend) ResolveSessionRef(ref string) (store.SessionRef, error) {
	panic("unexpected ResolveSessionRef call")
}
